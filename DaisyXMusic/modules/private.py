    ...
    client.send_message(message.chat.id,
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton(
                        "📲 Yeniliklər kanalı", url=f"https://t.me/{UPDATES_CHANNEL}"), 
                    InlineKeyboardButton(
...
async def gstart(_, message: Message):
    await message.reply_text(
        f"""**🔴 {PROJECT_NAME} artıq istifadədir.**""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
...
def map(pos):
    if(pos==1):
        ...
        button = [
            ...
            [InlineKeyboardButton(text = '📲 Yeniliklər kanalı', url=f"https://t.me/{UPDATES_CHANNEL}"),
...
async def ghelp(_, message: Message):
    await message.reply_text(
        f"""**🙋‍♀️ Salam mən Telegramda səsli musiqi botuyam.**""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "🟡 Kömək almaq 🟡", url=f"https://t.me/{BOT_USERNAME}?start"
                    )
                ]
            ]
        ),
